...
public class AuthenticationController {
    ...
    void initialize() {
        ...
        btn_login.setOnAction(event -> {
            connect();
            ControllersUtil.showAndHideStages("/fxml/main_panel.fxml", btn_login);
        });
        ...
        btn_registration.setOnAction(event -> {
            connect();
            ControllersUtil.showAndHideStages("/fxml/registration.fxml", btn_registration);
        });

        btnTCP_IP.setOnAction(event -> ControllersUtil.showAndHideStages("/fxml/connaction_properties.fxml",btnTCP_IP));
    }
